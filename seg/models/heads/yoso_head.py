...
class CrossAttenHead(nn.Module):
    ...
    def __init__(self,
        ...
        # Replace MultiheadAttention with DySepConvAtten
        if self.use_self_attn:
            ...
            # Use DySepConvAtten instead of MultiheadAttention
            self.s_atten = DySepConvAtten(self.feat_channels, self.num_proposals, conv_kernel_size_1d)
    ...
    def forward(self, features, proposal_kernels, mask_preds, self_attn_mask=None):
        ...
        # Self-attention or DySepConvAtten
        if self.use_self_attn:
            # [N, B, C]
            k = k.permute(1, 0, 2)
            ...
            # Use DySepConvAtten: query and value are both k
