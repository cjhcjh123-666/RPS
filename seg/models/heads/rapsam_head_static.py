...
# 轻量级修改：只替换动态卷积(DySepConvAtten)为静态深度可分离卷积
# Author: chenjiahui <chenjiahui2025@ia.ac.cn>
import copy
import os
...
from .yoso_head_static import CrossAttenHead, KernelUpdator

@MODELS.register_module()
class RapSAMVideoHeadStatic(Mask2FormerVideoHead):
    ...
    def __init__(self,
        ...
        # 仅在开启 prompt 训练时创建相关模块，避免无谓参数与计算
        # Add prompt_training attribute (提前以便条件构建)
